...
static struct FScriptStruct_FPS_StaticRegisterNativesFSlotImage
{
	...
	UFunction* Z_Construct_UFunction_UUIComponent_IsAvailable()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Collum = { UE4CodeGen_Private::EPropertyClass::Int, "Collum", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventIsAvailable_Parms, Collum), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Row = { UE4CodeGen_Private::EPropertyClass::Int, "Row", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventIsAvailable_Parms, Row), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	UFunction* Z_Construct_UFunction_UUIComponent_ResetImage()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Collum = { UE4CodeGen_Private::EPropertyClass::Int, "Collum", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventResetImage_Parms, Collum), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Row = { UE4CodeGen_Private::EPropertyClass::Int, "Row", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventResetImage_Parms, Row), METADATA_PARAMS(nullptr, 0) };
	...
	UFunction* Z_Construct_UFunction_UUIComponent_SetImage()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Collum = { UE4CodeGen_Private::EPropertyClass::Int, "Collum", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventSetImage_Parms, Collum), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_Row = { UE4CodeGen_Private::EPropertyClass::Int, "Row", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(UIComponent_eventSetImage_Parms, Row), METADATA_PARAMS(nullptr, 0) };
	...
	UClass* Z_Construct_UClass_UUIComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UUIComponent_ResetImage, "ResetImage" }, // 2665701139
				{ &Z_Construct_UFunction_UUIComponent_SetImage, "SetImage" }, // 875189323
			};
#if WITH_METADATA
