...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_ABaseEnemy, "GetIsAiming", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04080401, sizeof(BaseEnemy_eventGetIsAiming_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_ABaseEnemy()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ABaseEnemy_GetIsAiming, "GetIsAiming" }, // 3424446428
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_p_AudioComponent = { UE4CodeGen_Private::EPropertyClass::Object, "p_AudioComponent", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000090009, 1, nullptr, STRUCT_OFFSET(ABaseEnemy, p_AudioComponent), Z_Construct_UClass_UAudioComponent_NoRegister, METADATA_PARAMS(NewProp_p_AudioComponent_MetaData, ARRAY_COUNT(NewProp_p_AudioComponent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABaseEnemy, 797312746);
