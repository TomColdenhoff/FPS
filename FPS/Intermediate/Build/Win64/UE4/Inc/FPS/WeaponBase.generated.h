...
private: \
	static void StaticRegisterNativesUWeaponBase(); \
	friend FPS_API class UClass* Z_Construct_UClass_UWeaponBase(); \
public: \
	DECLARE_CLASS(UWeaponBase, USceneComponent, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/FPS"), NO_API) \
	DECLARE_SERIALIZER(UWeaponBase) \
...
#define FPS_Source_FPS_WeaponBase_h_13_STANDARD_CONSTRUCTORS \
	...
	NO_API UWeaponBase(const FObjectInitializer& ObjectInitializer); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UWeaponBase) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UWeaponBase); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UWeaponBase); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UWeaponBase(UWeaponBase&&); \
	NO_API UWeaponBase(const UWeaponBase&); \
public:
...
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UWeaponBase); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UWeaponBase); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(UWeaponBase)
